...
## 8. 進階照顧機制：Care Mistakes 與進化
Tamagotchi 的形態進化並非隨機，而是由「照顧失誤 (Care Mistakes)」的次數決定的。

### 什麼是 Care Mistake (照顧失誤)？
當寵物的「呼叫提示 (Attention)」圖示亮起（因為肚子餓或心情不好）時，若您在 **15 分鐘內** 沒有處理，呼叫燈會自動熄滅，這時系統就會計入 **1 次 Care Mistake**。
*   **燈光失誤**：寵物睡覺後若超過 1 小時未關燈，也會計入 Care Mistake。
*   **疾病處理**：生病時未及時打針，同樣會影響健康評價。

### 進階判定準則 (Tiers)
根據照顧品質，寵物的成年形態通常分為五個等級：
1.  **精英 (Serious)**：0-1 次照顧失誤，能進化成最健康、長壽的形態。
2.  **一般 (Normal)**：約 2 次照顧失誤。
3.  **頑皮 (Naughty)**：心情疏忽較多。
